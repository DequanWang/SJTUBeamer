...
\documentclass[xcolor=table,dvipsnames,svgnames,aspectratio=169,fontset=macnew]{ctexbeamer}
...
\usepackage[backend=bibtex,style=ieee,citestyle=numeric,maxcitenames=1,mincitenames=1,firstinits=false,uniquename=false]{biblatex}
...
\usetheme[blue,light,max,default]{sjtubeamer}
